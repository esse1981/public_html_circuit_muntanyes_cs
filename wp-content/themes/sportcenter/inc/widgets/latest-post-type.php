...
class Leaf_Recent_Posts extends WP_Widget {	
	function __construct() {
    	$widget_ops = array(
			...
			'description' => esc_html__('Leafcolor Latest Posts ','sportcenter')
		);
    	parent::__construct('leaf-recent-posts', esc_html__('Leafcolor Latest Posts ','sportcenter'), $widget_ops);
	}
			...
			while($the_query->have_posts()): $the_query->the_post();
				$html .='<div class="item">';
					...
					$html .='<div class="leaf-details item-content">
						...
						<span class="leaf-widget-meta">'.( ($post_type=='tribe_events'&&class_exists('Tribe__Events__Main'))?tribe_events_event_schedule_details():get_the_time(get_option('date_format'),get_the_ID()) ).'</span>
					</div>';
	...
	function form( $instance ) {
		...
		?>
        <p><label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:','sportcenter'); ?></label>
        <input class="widefat" id="<?php echo esc_attr($this->get_field_id('title')); ?>" name="<?php echo esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($title); ?>" /></p>
      	<!-- /**/-->        
        <p><label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php esc_html_e('Number of posts:','sportcenter'); ?></label>
        <input id="<?php echo esc_attr($this->get_field_id('number')); ?>" name="<?php echo esc_attr($this->get_field_name('number')); ?>" type="text" value="<?php echo esc_attr($number); ?>" size="3" /></p>

      	<!-- /**/-->
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php esc_html_e('Post type','sportcenter'); ?></label> 
          <select name="<?php echo esc_attr($this->get_field_name('post_type')); ?>" id="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
              <option value="post" <?php if($post_type=='post'){?> selected="selected"<?php }?>><?php esc_html_e('Post','sportcenter'); ?></option>
              <option value="tribe_events" <?php if($post_type=='tribe_events'){?> selected="selected"<?php }?>><?php esc_html_e('Event','sportcenter'); ?></option>
              <option value="product" <?php if($post_type=='product'){?> selected="selected"<?php }?>><?php esc_html_e('Product','sportcenter'); ?></option>
            </select>
        </p>
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('tags')); ?>"><?php esc_html_e('Tags:','sportcenter'); ?></label> 
		...
		<!--//-->
         <p>
            <label for="<?php echo esc_attr($this->get_field_id('cats')); ?>" class="app-cat-widget"><?php esc_html_e('Categories:','sportcenter');?></label>
        ...
        <p>
          <label for="<?php echo esc_attr($this->get_field_id('ids')); ?>"><?php esc_html_e('IDs to show:','sportcenter'); ?></label> 
...
add_action( 'widgets_init', create_function( '', 'return register_widget("Leaf_Recent_Posts");' ) );