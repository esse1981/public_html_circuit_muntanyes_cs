...
get_template_part( 'templates/header/header', 'navigation-top' );
?>
    ...
    <nav class="navbar navbar-inverse <?php if($nav_style){ ?> style-off-canvas <?php }?>">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo get_template_directory_uri() ?>/images/web-logo.png" alt="<?php esc_attr_e('Home','sportcenter'); ?>"></a>
                <?php else:?>
                <a class="logo" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e('Home','sportcenter'); ?>"><img src="<?php echo esc_url(leaf_get_option('logo_image')); ?>" alt="<?php esc_attr_e('Home','sportcenter'); ?>"/></a>
                <?php endif;?>
                
                <?php if(leaf_get_option('sticky_logo_image') != '' && leaf_get_option('nav_sticky','on')=='on'):?>
                <a class="logo sticky" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e('Home','sportcenter'); ?>"><img src="<?php echo esc_url(leaf_get_option('sticky_logo_image')); ?>" alt="<?php esc_attr_e('Home','sportcenter'); ?>"/></a>
                <?php endif;?>
            </div>
            ...
            <button type="button" class="mobile-menu-toggle <?php if($nav_style){?> <?php }else{ ?> visible-xs <?php }?>">
                <span class="sr-only"><?php esc_html_e('Menu','sportcenter') ?></span>
