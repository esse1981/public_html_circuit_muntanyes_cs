            ...
            <div class="top-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="menu-item menu-item-has-children parent dropdown mycart sub-menu-left">
                        <a href="<?php echo esc_url($cart_url);?>" class="menu-link"><i class="fa fa-shopping-cart"></i></a>
                        <ul class="dropdown-menu menu-depth-1">
                            <li class="sub-menu-item  menu-item-depth-1 menu-item menu-item-type-post_type"><a href="<?php echo esc_url($cart_url);?>" class="menu-link  sub-menu-link"><?php esc_html_e('View Cart','sportcenter') ?><?php echo ' ('.$woocommerce->cart->get_cart_contents_count(),')';?></a></li>
                            <li class="sub-menu-item menu-item-depth-1 menu-item menu-item-type-post_type"><a href="<?php echo esc_url($checkout_url);?>" class="menu-link  sub-menu-link"><?php esc_html_e('Check Out','sportcenter') ?></a></li>
                        </ul>
                    </li>
                    <?php } }?>
                    <?php 
